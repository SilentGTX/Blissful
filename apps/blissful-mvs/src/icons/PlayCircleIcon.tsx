...
export function PlayCircleIcon({ className, size = 18 }: PlayCircleIconProps) {
  return (
    <svg className={className} viewBox="0 0 512 512" width={size} height={size} fill="none" aria-hidden="true">
      <path
