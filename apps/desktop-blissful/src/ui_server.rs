...
/// (`apps/web-blissful/dist`, a staged `blissful-ui/`), so local edits + HMR
...
fn detect_static_root() -> Option<PathBuf> {
    ...
    let candidates = [
        ...
        // Per-crate target dir: exe at apps/desktop-blissful/target/debug,
        ...
        exe_dir.join("../../../../apps/web-blissful/dist"),
        exe_dir.join("../../../apps/web-blissful/dist"),
